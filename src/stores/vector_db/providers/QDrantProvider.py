...
def insert_many(self, collection_name: str, texts: list,
    ...
    Args:
        ...
        metadata (list, optional): A list of dictionaries containing extra info (e.g., source, date). 
            Defaults to None.
    ...
    """
    # Initialize metadata and record_ids as lists of None if not provided
    if metadata is None:
    ...
    for i in range(0, len(texts), batch_size):
        ...
        b_metadata = metadata[i:batch_end]
